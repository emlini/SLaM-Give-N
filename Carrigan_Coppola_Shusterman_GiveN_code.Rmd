...
setwd("C:/Users/jmhen/Documents/Give-N_Data") #if necessary
...
```{r}
GN_lg_noNA <- subset(GiveN_subset, GiveN_subset$GN_Lg_propcorr_NA!='' & GiveN_subset$GN_sm_2cat!="NOT CP-knower" & GiveN_subset$MAX_COUNT_SEQ!='')
...
#Without MAX_COUNT_SEQ
GN_lg_polr_noHC <- polr(formula = GN_lg_factor ~ SES..8.66. + Language_Modality + Age + Language_Timing, data = GN_lg_noNA,  method = "probit", Hess = TRUE) 
summary(GN_lg_polr_noHC)  # res dev 262   AIC: 280
tidy(GN_lg_polr_noHC, conf.int = TRUE, p.value=TRUE)
dropterm(GN_lg_polr_noHC)

lipsitz.test(GN_lg_polr_noHC) #ns
logitgof(GN_lg_noNA$GN_lg_factor, fitted(GN_lg_polr_noHC)) #ns
pulkrob.chisq(GN_lg_polr_noHC, c("Language_Modality", "Language_Timing")) #ns

#With MAX_COUNT_SEQ
GN_lg_polr_wHC <- polr(formula = GN_lg_factor ~ SES..8.66. + Language_Modality + Age + Language_Timing + MAX_COUNT_SEQ, data = GN_lg_noNA,  method = "probit", Hess = TRUE) 
summary(GN_lg_polr_wHC)  # res dev 261   AIC: 281
tidy(GN_lg_polr_wHC, conf.int = TRUE, p.value=TRUE)
dropterm(GN_lg_polr_wHC)

lipsitz.test(GN_lg_polr_wHC) #ns
logitgof(GN_lg_noNA$GN_lg_factor, fitted(GN_lg_polr_wHC)) #ns
pulkrob.chisq(GN_lg_polr_wHC, c("Language_Modality", "Language_Timing")) #ns

#Comparing WITH vs WITHOUT HC models
anova(GN_lg_polr_wHC,GN_lg_polr_noHC)

## checking RESIDUALS
sres <- resids(GN_lg_polr_noHC)

#NOT WORKING AS OF 12/27/2024
