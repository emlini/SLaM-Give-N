...
BG <-dplyr::select(Background_Info, c(SUBJECT.ID, How.often.does.the.primary.caregiver.use.ASL.with.the.child.,How.often.does.the.primary.caregiver.use.ASL.with.the.child., Does.your.child.have.regular.contact.with.any.additional.family.members.e.g..older.or.younger.siblings..grandparents..cousins..etc...who.use.ASL., Total.time.in.signing.program..mo.))
View(BG)
...
with(Later_Only, chisq.test(Language_Modality, Age.of.Exposure..mo.))
